...
handoffs:
  - label: "Document Root Cause"
    agent: "ask"
    prompt: "Use css-debug-root-cause-analysis to document the root cause systematically"
    send: false
  - label: "Implement Fix"
    agent: "css-developer"
  ...
  - label: "Generate Validation Checklist"
    agent: "ask"
    prompt: "Use css-debug-validation-checklist to create post-fix validation checklist"
    send: false
